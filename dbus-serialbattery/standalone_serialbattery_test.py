...
sasb = standalone_serialbattery(DEVPATH, DRIVEROPTION, DEVADR, LOGLEVEL)
sasb.bms_open()
sleep(0.5)

for key_address in sasb.BatIds:
    ...
    print("temperature_3   : " + str(sasb.temperature_3))
    print("temperature_4   : " + str(sasb.temperature_4))
